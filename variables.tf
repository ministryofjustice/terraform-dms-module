...
variable "dms_source" {
  ...
  validation {
    ...
    error_message = "For engine_name 'oracle': sid must be set, database_name must NOT be set."
  }
  ...
  validation {
    ...
    error_message = "For engine_name 'postgres': database_name must be set, sid must NOT be set."
  }
