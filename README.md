...
|------|-------------|------|---------|:--------:|
| <a name="input_cdc_jobs"></a> [cdc\_jobs](#input\_cdc\_jobs) | n/a | <pre>map(object({<br/>    replication_task_id = string<br/>    cdc_start_time      = optional(string)<br/>    mapping_rules = object({<br/>      bucket = string<br/>      key    = string<br/>    })<br/>  }))</pre> | `{}` | no |
