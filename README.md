...
| <a name="input_replication_instance_arns"></a> [replication\_instance\_arns](#input\_replication\_instance\_arns) | If null, create a new replication instance. If set, adopt (import) these existing instances. | `set(string)` | `null` | no |
